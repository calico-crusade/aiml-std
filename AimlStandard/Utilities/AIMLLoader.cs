...
namespace AimlStandard.Utilities
{
    ...
    public class AIMLLoader
    {
        ...
        public string Normalize(string input, bool isUserInput)
        {
            ...
            Normalize.ApplySubstitutions substitutor = new AimlStandard.Normalize.ApplySubstitutions(this.bot);
            Normalize.StripIllegalCharacters stripper = new AimlStandard.Normalize.StripIllegalCharacters(this.bot);
